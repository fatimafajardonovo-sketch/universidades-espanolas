...
const universidades = [
  ...
  { nombre: 'Universidades de Ceuta y Melilla', ccaa: 'ceuta-melilla', url: '/por-ccaa/ceuta-melilla.html' },
  { nombre: 'Universidades de Comunidad de Madrid', ccaa: 'madrid', url: '/por-ccaa/madrid.html' },
  { nombre: 'Universidades de Comunidad Valenciana', ccaa: 'comunidad-valenciana', url: '/por-ccaa/comunidad-valenciana.html' },
...
// Datos de ejemplo: sustituye este array por tus universidades reales
// (o cárgalo con fetch desde un .json si prefieres separar datos y lógica)
